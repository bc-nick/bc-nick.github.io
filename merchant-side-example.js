...
async function createCartWithGraphQL(productId) {
    ...
    try {
        ...
        setCookie('cartId', createCart.cart.entityId, { secure: false, httpOnly: false, sameSite: 'lax' });
...
async function onRenderWalletButtonsButtonClick() {
    ...
    setCookie('cartId', cartEntityId, { secure: false, httpOnly: false, sameSite: 'lax' });
